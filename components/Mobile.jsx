...
const Mobile = ({ showPopup, showModal }) => {
    ...
    return (
        <>
            {loadedContent &&
                <>
                    <div className="fixed top-4 w-full z-20 flex justify-between px-5 items-center" style={{ zIndex: 80 }}>
                        <div className="logo h-fit cursor-pointer relative" style={{ zIndex: 1001 }}>
                            <svg className={`w-10 h-10 ${menu ? 'text-pink' : 'text-white'}`}
                    ...
                    <div className={`content bg-lavender relative ${menu ? 'overflow-hidden' : ''}`}>
                        ...
                        <section className="about-vac relative text-white px-6 py-16 h-100vh overflow-hidden flex flex-col">
                            ...
                            <div className="flex gap-4 items-center w-10/12 mt-8 relative">
                                <Icon id={0}
                                    img={`<svg viewBox="0 0 32 31" fill="none" 
                            xmlns="http://www.w3.org/2000/svg">
                            <path d="M0.81127 11.5946L15.9464 29L31.0815 11.5946" stroke="currentColor" 
                            strokeWidth="1.5" strokeLinecap="round"/>
                            <path d="M11 15L15.0583 26.3631C15.3743 27.248 16.6257 27.248 16.9417 26.3631L21 15" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round"/><path d="M15.9463 29L15.9463 1" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round"/></svg>`} />
